...
<div class="container">
	<<form action="admininfocontroller.do?command=infoupdate&member_No=${dto.member_No}&info_No=${one.info_No}" method="post" enctype="multipart/form-data">
		
			<!-- 리뷰쓰기 -->
			<h1 class="mt-4">리뷰 수정</h1>
			<hr>
			<p>아이디: ${one.info_Writer}</p>
