...
<%@include file="../../nav/navlogin.jsp"%>
    ...
    <div id="write">
        ...
        <%if(list.getRecipe_Writer().equals(dto.getMember_Id()) || (dto.getGrade_Code() == 1)) { %>

         |<a href="adminrecipecontroller.do?command=delete&recipe_No=${list.recipe_No}&member_Id=${dto.member_Id }&recipe_writer=${list.recipe_Writer }&grade_code=${dto.grade_Code}"  class="button">삭제</a>
         |<a href="adminrecipecontroller.do?command=updateform&recipe_No=${list.recipe_No}&member_Id=${dto.member_Id }&recipe_writer=${list.recipe_Writer }" class="button">수정</a>
		<%} %>
    ...
    <div><br><br><br></div>
       ...
       <div id="extra" class="container" style="width: 70%; float: left; margin-left: 5%;"  >
        <h2>댓글</h2> 
          ...
          <form action="adminrecipecontroller.do?command=answer" method="post">
          ...
          <table>
              ...
              <tr>
               ...
               <td>
             	...
             	<button class="smallbutton" onclick="location.href='adminrecipecontroller.do?command=deleteanswer&recipe_No=${list.recipe_No}&answer_No=${ans.answer_No}&grade_code=${dto.grade_Code}'">삭제</button>
             	<button class="smallbutton" onclick="location.href='adminrecipecontroller.do?command=updateanswerform&recipe_No=${list.recipe_No}&answer_No=${ans.answer_No}&member_Id=${dto.member_Id}&answer_writer=${ans.answer_Writer}'">수정</button>
