...
<%@include file="../nav/navlogin1.jsp"%>
 	 <div id="write">
          ...
          <a href="../userrecipecontroller.do?command=list" class="button"> 취소</a>
        </div>
    <div><br><br><br></div>
 
    <h2 id="title1">레시피 작성하기</h2>
     <form action="../userrecipecontroller.do?command=write&member_No=${dto.member_No}" method="post" enctype="multipart/form-data">
