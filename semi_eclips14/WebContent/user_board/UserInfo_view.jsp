...
<%@include file="../nav/navbootstrap.jsp"%>
 ...
 <%if(inf.getInfo_Writer().equals(dto.getMember_Id())) {%> 
     <div style="padding: 10%;">
        <input type="button" value="수정" class="smallbutton" onclick="location.href='userinfocontroller.do?command=updateInfoForm&info_No=${list.info_No}'">
      <input type="button" value="삭제" class="smallbutton" onclick="location.href='userinfocontroller.do?command=delete&info_No=${list.info_No}'">   
    <%} %> 
   <input type="button" value="메인" class="smallbutton" onclick="location.href='userinfocontroller.do?command=list'">
   </div>
  <div class="container" style="border: 1px solid #D8D8D8;">
        ...
        <!-- Post Content -->
        <p class="lead" style="color: black;"><%=inf.getInfo_Text() %></p>
      ...
      <br>
        ...
        <div class="card my-4 p-5">
          <h5 class="card-header" style="border: 1px solid #D8D8D8;">댓글:</h5>
...
%> 
	...
	<input type="button" value="수정" class="smallbutton" onclick="location.href='userinfocontroller.do?command=updateanswerform&info_No=${ans.info_No}&answer_No=${ans.answer_No}'">
	<input type="button" value="삭제" class="smallbutton" onclick="location.href='userinfocontroller.do?command=deleteanswer&info_No=${ans.info_No}&answer_No=${ans.answer_No}'">   
