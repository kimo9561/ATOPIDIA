...
public class UserInfoDaoImpl  implements UserInfoDao{
	...
	@Override
	public int insertInfo(Connection con,UserInfoDto dto) {
		PreparedStatement pstm = null;
		int res = 0;
	...
	public int insertAnswer(Connection con,UserInfoAnswerDto dto) {
		...
		System.out.println(dto.getAnswer_Writer());
		try {
	...
	public List<UserInfoAnswerDto> answerlist(Connection con, int info_No) {
		PreparedStatement pstm = null;
		ResultSet rs = null;
		List<UserInfoAnswerDto> res = new ArrayList<UserInfoAnswerDto>();
		...
		try {
			...
			while (rs.next()) {
				UserInfoAnswerDto tmp = new UserInfoAnswerDto();
	...
	public UserInfoAnswerDto answerSelectOne(Connection con, int info_No, int answer_No) {
		PreparedStatement pstm = null;
		ResultSet rs = null;
	...
	public int updateAnswer(Connection con, UserInfoAnswerDto dto) {
		PreparedStatement pstm = null;
		int res = 0;
	...
	public List<UserInfoDto> user_bestInfo(Connection con) {
		...
		try {
			...
			while(rs.next()) {
				UserInfoDto tmp = new UserInfoDto();
				tmp.setInfo_No(rs.getInt(1));
