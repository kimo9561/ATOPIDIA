...
public class UserRecipeDto {
	...
	public UserRecipeDto(int recipe_No, int member_No, String recipe_Writer, String recipe_Title,
	...
	public UserRecipeDto(int recipe_No, int member_No, String recipe_Writer, String recipe_Title, String recipe_Ingredient,
			String recipe_Text, Date recipe_Date, int recipe_Hits, String recipe_Save, int grade_Code) {
		super();
		this.recipe_No = recipe_No;
		this.member_No = member_No;
		this.recipe_Writer = recipe_Writer;
	...
	public UserRecipeDto(int recipe_No, String recipe_Title, String recipe_Ingredient, String recipe_Text,
	...
	public UserRecipeDto(int member_No, String recipe_Writer, String recipe_Title, String recipe_Ingredient,
	...
	public UserRecipeDto(int recipe_No, int recipe_Hits) {
		super();
		this.recipe_No = recipe_No;
		this.recipe_Hits = recipe_Hits;
	}
