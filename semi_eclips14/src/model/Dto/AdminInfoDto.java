...
public class AdminInfoDto {
	...
	public AdminInfoDto(int info_No, int member_No, String info_Title, String info_Text, String info_Image_Name,
	...
	public AdminInfoDto(int info_No, int member_No, String info_Writer, String info_Title, String info_Text,
	...
	public AdminInfoDto(int member_No, String info_Writer, String info_Title, String info_Text, String info_Image_Name,
			String info_Image_Realname, String info_Image_Uploadpath) {
		super();
		this.member_No = member_No;
		this.info_Writer = info_Writer;
	...
	public AdminInfoDto(String info_Writer, String info_Title, String info_Text, String info_Image_Name,
			String info_Image_Realname, String info_Image_Uploadpath) {
		super();
		this.info_Writer = info_Writer;
		this.info_Title = info_Title;
	...
	public AdminInfoDto(String info_Title, String info_Text) {
		super();
		this.info_Title = info_Title;
		this.info_Text = info_Text;
	}
	...
	public AdminInfoDto(int info_No, int member_No, String info_Title, String info_Text) {
		super();
		this.info_No = info_No;
		this.member_No = member_No;
		this.info_Title = info_Title;
	...
	public AdminInfoDto(int info_No, String info_Writer, String info_Title, String info_Text) {
		super();
		this.info_No = info_No;
		this.info_Writer = info_Writer;
		this.info_Title = info_Title;
